...
export const marbleCollections: Record<string, MarbleCollection> = {
  'gorgeous-grey': {
    ...
    varieties: [
      ...
      { name: 'Cinereous Grey', image: '/images/variety-cinereous-grey.png' },
      { name: 'Princess Grey', image: '/images/variety-princess-grey.png' },
      { name: 'Versache Grey', image: '/images/variety-versace-grey.png' },
      { name: 'Grey Flurry', image: '/images/variety-grey-flurry.png' },
      { name: 'Silver River', image: '/images/variety-silver-river.png' },
      { name: 'Riviera Grey', image: '/images/variety-riviera-grey.png' },
      { name: 'Alaska Grey', image: '/images/variety-alaska-grey.png' },
      { name: 'Fire Grey', image: '/images/variety-fire-grey.png' },
      { name: 'Repen Grey', image: '/images/variety-repen-grey.png' },
    ],
  },
  'beautiful-beige': {
    id: 'beautiful-beige',
  ...
  'wow-white': {
    ...
    varieties: [
      ...
      { name: 'Blanco Carrara', image: '/images/variety-blanco-carrara.png' },
      { name: 'Pure White', image: '/images/variety-pure-white.png' },
      { name: 'Artic White', image: '/images/variety-arctic-white.png' },
      { name: 'Crystal White', image: '/images/variety-crystal-white.png' },
      { name: 'Polar White', image: '/images/variety-polar-white.png' },
      { name: 'Alpine White', image: '/images/variety-alpine-white.png' },
      { name: 'Pearl White', image: '/images/variety-pearl-white.png' },
      { name: 'Diamond White', image: '/images/variety-diamond-white.png' },
      { name: 'Ivory White', image: '/images/variety-ivory-white.png' },
    ],
  },
  'bold-black': {
    id: 'bold-black',
